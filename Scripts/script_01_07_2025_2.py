...
def fetch_patent_details(patent_id, serpapi_api_key):
    ...
    # Collect basic details — no Patent/Application Number
    patent_data = {
...
if __name__ == "__main__":
    ...
    if all_patent_data:
        ...
        # ✅ Optional: Remove duplicates by Title & Publication Number instead
        combined_df.drop_duplicates(subset=["Title", "Publication Number"], keep="last", inplace=True)
