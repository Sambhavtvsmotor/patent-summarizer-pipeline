...
def fetch_patent_details(patent_id, serpapi_api_key):
    ...
    patent_data = {
        "Patent/Application Number": patent_id,
...
if __name__ == "__main__":
    ...
    if all_patent_data:
        ...
        # ✅ Optional: Remove duplicates by Patent/Application Number
        combined_df.drop_duplicates(subset=["Patent/Application Number"], keep="last", inplace=True)
